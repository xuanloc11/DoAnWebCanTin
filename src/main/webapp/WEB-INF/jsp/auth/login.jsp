...
<head>
  ...
  <style>
    ...
    .login-card{ width:min(420px,100%); background:#fff; border:1px solid var(--border); border-radius: 16px; box-shadow: var(--shadow); padding: 20px; font-size: 14px; margin-top: -50px; }
    ...
    .success{ color:#065f46; background:#d1fae5; border:1px solid #a7f3d0; padding:6px 8px; border-radius:8px; margin:6px 0; font-size: 13px; }
